...
__all__ = ["TestBirdClientShowTRIP6"]


class TestBirdClientShowTRIP6(BirdClientTestBaseCase):
    """Test the BirdClient class."""

    def test_show_t_rip6(self, testpath: str) -> None:
        """Test show RIP6 table."""

        birdclient = BirdClient()
        result = birdclient.show_route_table("t_rip6", self.load_test_data(testpath, "test_show_t_rip6.txt"))
