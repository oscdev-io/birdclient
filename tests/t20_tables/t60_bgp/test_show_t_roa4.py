...
__all__ = ["TestBirdClientShowTROA4"]


class TestBirdClientShowTROA4(BirdClientTestBaseCase):
    """Test the BirdClient class."""

    def test_show_t_roa4(self, testpath: str) -> None:
        """Test show t_roa4 table."""

        birdclient = BirdClient()
        result = birdclient.show_route_table("t_roa4", self.load_test_data(testpath, "test_show_t_roa4.txt"))
