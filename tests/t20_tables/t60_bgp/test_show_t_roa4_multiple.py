...
__all__ = ["TestBirdClientShowTROA4Multiple"]


class TestBirdClientShowTROA4Multiple(BirdClientTestBaseCase):
    """Test the BirdClient class."""

    def test_show_t_roa4_multiple(self, testpath: str) -> None:
