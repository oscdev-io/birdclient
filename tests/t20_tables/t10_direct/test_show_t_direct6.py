...
__all__ = ["TestBirdClientShowTDirect6"]


class TestBirdClientShowTDirect6(BirdClientTestBaseCase):
    """Test the BirdClient class."""

    def test_show_t_direct6(self, testpath: str) -> None:
        """Test show direct6 table."""

        birdclient = BirdClient()
        result = birdclient.show_route_table("t_direct6", self.load_test_data(testpath, "test_show_t_direct6.txt"))
