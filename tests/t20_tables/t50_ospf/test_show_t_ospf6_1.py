...
__all__ = ["TestBirdClientShowTOSPF61"]


class TestBirdClientShowTOSPF61(BirdClientTestBaseCase):
    """Test the BirdClient class."""

    def test_show_t_ospf6_1(self, testpath: str) -> None:
        """Test show OSPF6 table."""

        birdclient = BirdClient()
        result = birdclient.show_route_table("t_ospf6", self.load_test_data(testpath, "test_show_t_ospf6_1.txt"))
